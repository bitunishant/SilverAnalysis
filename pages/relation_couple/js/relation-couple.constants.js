...
export const TRAIT_DATA = {
  emotional: {
    ...
    "emotional-2":
      "Mixed approach - Mixed of Emotional and Practical personality",
  ...
  communication: {
    ...
    "comm-3":
      "Adaptable communication - sometimes take time to express, sometimes share easily",
  ...
  intimacy: {
    ...
    "intimacy-3":
      "Lower intimacy needs - hesitates/repel in physical connections",
  },
  family: {
    ...
    "family-4":
      "Balanced name and surname - Harmony between individual and family's perspective",
