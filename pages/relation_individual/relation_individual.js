...
const traitData = {
  ...
  conflict: {
    "conflict-1":
      "Healthy conflict resolution - addresses issues constructively",
    ...
    "conflict-4":
      "Open to feedback - willing to consider different perspectives",
    "conflict-5":
      "Tendency for relationship conflicts - needs communication work",
  ...
  intimacy: {
    ...
    "intimacy-2":
      "Balanced intimacy needs - healthy physical relationship approach",
    "intimacy-3":
      "Lower intimacy needs - values emotional over physical connection",
  },
  family: {
    ...
    "family-3":
      "Family-first mentality - prioritizes family over individual needs",
  ...
  financial: {
    ...
    "financial-2":
      "Balanced financial approach - saves and spends appropriately",
...
// helper function to resolve checkbox label text from a container.
...
function updateCompatibility() {
  ...
  compatibleList.innerHTML = compatible
    .map((item) => `<li>${item}</li>`)
    .join("");
...
function applyToPreview() {
  ...
  document.getElementById("r_age").textContent =
  ...
  document.getElementById("r_compat_name").textContent =
    document.getElementById("userName").value;
  document.getElementById("r_footer_name").textContent =
    document.getElementById("userName").value;
...
function updateTraitAnalyses() {
  const categories = [
    {
      containerId: "emotionalSelect",
      listId: "r_emotional_list",
      dataKey: "emotional",
    },
    {
    ...
    {
      containerId: "conflictSelect",
      listId: "r_conflict_list",
      dataKey: "conflict",
    },
    {
      containerId: "intimacySelect",
      listId: "r_intimacy_list",
      dataKey: "intimacy",
    },
    { containerId: "familySelect", listId: "r_family_list", dataKey: "family" },
    {
      containerId: "financialSelect",
      listId: "r_financial_list",
      dataKey: "financial",
    },
  ];
...
function resetForm() {
  ...
  document.getElementById("handwritingPreview").innerHTML =
    "No handwriting uploaded";
...
document
  ...
  ?.addEventListener("click", downloadHtmlSnapshot);

// Keep right preview in sync when traits are checked/unchecked.
...
document
  .getElementById("uploadHandwriting")
  .addEventListener("change", function () {
